...
#list all unique generes 
def list_genres(df):
    return sorted (set(genre.strip()for sublist in df['genres'].dropna().str.split(',') for genre in sublist))

genres = list_genres(movies_df)

#recommed movies based on filters
