...
cv2.putText(image_rgb,"Region 1",(top_left1[0],top_left1[1]-10),text,0.7,(255,255,255),2,cv2.LINE_AA)
cv2.putText(image_rgb,"Region 2",(top_left2[0],top_left2[1]-10),text,0.7,(255,255,255),2,cv2.LINE_AA)

cv2.putText(image_rgb,"center 1",(center1_x-40,center1_y+40),text,0.6,(0,255,0),2,cv2.LINE_AA)
cv2.putText(image_rgb,"center 2",(center2_x-40,center2_y+40),text,0.6,(0,255,0),2,cv2.LINE_AA)
...
cv2.putText(image_rgb,"Height",(height_label_position[0],height_label_position[1]),text,0.7,(255,255,0),2,cv2.LINE_AA)
